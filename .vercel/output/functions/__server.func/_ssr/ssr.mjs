...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BqTbHdF0.mjs");
...
var manifest = {
	"18591b310f2f01c1e1952f515818aa93f7b31163c1ba8acc8ec0c62d69756590": {
		functionName: "analyzeRequest_createServerFn_handler",
		importer: () => import("./actions-BC2ubNQg.mjs")
	},
	"c191430a360fbdda0b3e9b02494f9b203bec14ba61d49f2fe5fa89064b2fc081": {
		functionName: "runAccessSuite_createServerFn_handler",
		importer: () => import("./actions-BC2ubNQg.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CA87SzKp.mjs").then((n) => n.t),
